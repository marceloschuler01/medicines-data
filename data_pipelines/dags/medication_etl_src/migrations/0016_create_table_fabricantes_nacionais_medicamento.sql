...
(
 ...
 CONSTRAINT FK_17 FOREIGN KEY ( id_fabricante_nacional ) REFERENCES fabricante_nacional ( id_fabricante_nacional ),
 CONSTRAINT FK_18 FOREIGN KEY ( id_apresentacao_medicamento ) REFERENCES apresentacao_medicamento ( id_apresentacao_medicamento )
);
